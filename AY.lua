if AY_LOADED and not _G.AY_DEBUG == true then
    print("Aether Yield is already running!")
    return
end

pcall(function() getgenv().AY_LOADED = true end)
...
AYMouse = cloneref(Players.LocalPlayer:GetMouse())
...
-- xylex & europa
local AYassets = {
    ["Aetheryield/assets/bindsandplugins.png"] = "rbxassetid://5147695474",
    ["Aetheryield/assets/close.png"] = "rbxassetid://5054663650",
    ["Aetheryield/assets/editaliases.png"] = "rbxassetid://5147488658",
    ["Aetheryield/assets/editkeybinds.png"] = "rbxassetid://129697930",
    ["Aetheryield/assets/edittheme.png"] = "rbxassetid://4911962991",
    ["Aetheryield/assets/editwaypoints.png"] = "rbxassetid://5147488592",
    ["Aetheryield/assets/imgstudiopluginlogo.png"] = "rbxassetid://4113050383",
    ["Aetheryield/assets/logo.png"] = "rbxassetid://1352543873",
    ["Aetheryield/assets/minimize.png"] = "rbxassetid://2406617031",
    ["Aetheryield/assets/pin.png"] = "rbxassetid://6234691350",
    ["Aetheryield/assets/reference.png"] = "rbxassetid://3523243755",
    ["Aetheryield/assets/settings.png"] = "rbxassetid://1204397029"
}
...
if makefolder and isfolder and writefile and isfile then
    pcall(function() -- good executor trust
        ...
        for _, folder in {"Aetheryield", "Aetheryield/assets"} do
            if not isfolder(folder) then
                makefolder(folder)
            end
        end
        for path in AYassets do
            if not isfile(path) then
                writefile(path, game:HttpGet((path:gsub("Aetheryield/", assets))))
            end
        end
        if IsOnMobile then writefile("Aetheryield/assets/.nomedia") end
    end)
end

pcall(function() -- good executor trust x2
    for _, file in {"AY_FE", "AYSettings", "AYData", "settings", "fucku", "DexSettings", "jew", "1375859133001240586", "discord_id"} do
        delfile(file)
    end
end)
...
Title.TextSize = 18
Title.Text = "Aether Yield Remastered v" .. currentVersion
...
SettingsButton.Image = getcustomasset("Aetheryield/assets/settings.png")
...
ReferenceButton.Image = getcustomasset("Aetheryield/assets/reference.png")
...
ColorsButton = makeSettingsButton("Edit Theme",getcustomasset("Aetheryield/assets/edittheme.png"))
ColorsButton.Position = UDim2.new(0, 5, 0, 55)
ColorsButton.Size = UDim2.new(1, -10, 0, 25)
ColorsButton.Name = "Colors"
ColorsButton.Parent = SettingsHolder

Keybinds = makeSettingsButton("Edit Keybinds",getcustomasset("Aetheryield/assets/editkeybinds.png"))
Keybinds.Position = UDim2.new(0, 5, 0, 85)
Keybinds.Size = UDim2.new(1, -10, 0, 25)
Keybinds.Name = "Keybinds"
Keybinds.Parent = SettingsHolder

Aliases = makeSettingsButton("Edit Aliases",getcustomasset("Aetheryield/assets/editaliases.png"))
...
Positions = makeSettingsButton("Edit/Goto Waypoints",getcustomasset("Aetheryield/assets/editwaypoints.png"))
Positions.Position = UDim2.new(0, 5, 0, 145)
Positions.Size = UDim2.new(1, -10, 0, 25)
Positions.Name = "Waypoints"
Positions.Parent = SettingsHolder

EventBind = makeSettingsButton("Edit Event Binds",getcustomasset("Aetheryield/assets/bindsandplugins.png"),759)
EventBind.Position = UDim2.new(0, 5, 0, 205)
EventBind.Size = UDim2.new(1, -10, 0, 25)
EventBind.Name = "EventBinds"
EventBind.Parent = SettingsHolder

Plugins = makeSettingsButton("Manage Plugins",getcustomasset("Aetheryield/assets/bindsandplugins.png"),743)
...
CloseImage.Image = getcustomasset("Aetheryield/assets/close.png")
...
PinImage.ZIndex = 10
PinImage.Image = getcustomasset("Aetheryield/assets/pin.png")
...
Logo.Image = getcustomasset("Aetheryield/assets/logo.png")
...
Credits.Text = "itzC9 // Good // Aether-Yield"
...
ExitImage_2.Image = getcustomasset("Aetheryield/assets/close.png")
...
Img.Image = getcustomasset("Aetheryield/assets/imgstudiopluginlogo.png")
Img.ZIndex = 10
...
About.TextSize = 14
About.Text = "Plugins are .AY files and should be located in the 'workspace' folder of your exploit."
...
ExitImage_3.Image = getcustomasset("Aetheryield/assets/close.png")
...
PluginsHint.Text = "Download plugins from the AY Discord (discord.gg/78ZuWSq)"
...
ExitImage_5.Image = getcustomasset("Aetheryield/assets/close.png")
...
ImageLabel.Image = getcustomasset("Aetheryield/assets/minimize.png")
...
ImageLabel_2.Image = getcustomasset("Aetheryield/assets/close.png")
...
eventEditor = (function()
	...
	local main = create({
		...
		{5,"ImageLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Image=getcustomasset("Aetheryield/assets/close.png"),Parent={4},Position=UDim2.new(0,5,0,5),Size=UDim2.new(0,10,0,10),ZIndex=10,}},
		...
		{53,"ImageLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Image=getcustomasset("Aetheryield/assets/settings.png"),Parent={52},Position=UDim2.new(0,2,0,2),Size=UDim2.new(0,16,0,16),ZIndex=10,}},
	})
	main.Name = randomString()
...
reference = (function()
	local main = create({
		...
		{114,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Text",Parent={112},Position=UDim2.new(0,8,0,30),Size=UDim2.new(1,-8,0,32),Text="You can join the Discord server to get support with AY,  and read up on more documentation such as the Plugin API.",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
...
createPopup = function(text)
    ...
    ExitImage.Image = getcustomasset("Aetheryield/assets/close.png")
    ExitImage.ZIndex = 10
...
function saves()
    if writefileExploit() and readfileExploit() and jsonAttempts < 10 then
        local readSuccess, out = readfile("AY_FE.AY", true)
        if readSuccess then
            if out ~= nil and tostring(out):gsub("%s", "") ~= "" then
                local success, response = pcall(function()
                    ...
                    if vtype(json.keepAY, "boolean") then KeepInfYield = json.keepAY else KeepInfYield = true end
                ...
                if not success then
                    ...
                    writefile("AY_FE.AY", defaults, true)
                    wait()
                    saves()
                end
            else
                writefile("AY_FE.AY", defaults, true)
                wait()
                local dReadSuccess, dOut = readfile("AY_FE.AY", true)
...
function updatesaves()
	if nosaves == false and writefileExploit() then
		...
		writefileCooldown("AY_FE.AY", HttpService:JSONEncode(update))
	end
end
...
AYMouse.KeyDown:Connect(function(Key)
	if (Key==prefix) then
...
SaveChatlogs.MouseButton1Down:Connect(function()
	if writefileExploit() then
		if #scroll_2:GetChildren() > 0 then
			...
			local writelogs = '-- Aether Yield Chat logs for "'..placeName..'"\n'
			for _, child in pairs(scroll_2:GetChildren()) do
				writelogs = writelogs..'\n'..child.Text
			end
...
function selectPart()
	...
	local function HighlightPart()
		if selected.Adornee ~= AYMouse.Target then
			selectionBox.Adornee = AYMouse.Target
		else
			selectionBox.Adornee = nil
		end
	end
	ActivateHighlight = AYMouse.Move:Connect(HighlightPart)
	local function SelectPart()
		if AYMouse.Target ~= nil then
			selected.Adornee = AYMouse.Target
			Path.Text = getHierarchy(AYMouse.Target)
		end
	end
	ClickSelect = AYMouse.Button1Down:Connect(SelectPart)
end
...
CMDs = {}
CMDs[#CMDs + 1] = {NAME = 'discord / support / help', DESC = 'Invite to the Aether Yield support server.'}
...
CMDs[#CMDs + 1] = {NAME = 'hideAY', DESC = 'Hides the main AY GUI'}
CMDs[#CMDs + 1] = {NAME = 'showAY / unhideAY', DESC = 'Shows AY again'}
CMDs[#CMDs + 1] = {NAME = 'keepAY', DESC = 'Auto execute AY when you teleport through servers'}
CMDs[#CMDs + 1] = {NAME = 'unkeepAY', DESC = 'Disable keepAY'}
CMDs[#CMDs + 1] = {NAME = 'togglekeepAY', DESC = 'Toggle keepAY'}
...
CMDs[#CMDs + 1] = {NAME = 'Aetherjump / infjump', DESC = 'Allows you to jump before hitting the ground'}
CMDs[#CMDs + 1] = {NAME = 'unAetherjump / uninfjump', DESC = 'Disables infjump'}
...
function checkTT()
	local t
	local guisAtPosition = COREGUI:GetGuiObjectsAtPosition(AYMouse.X, AYMouse.Y)
	...
	if t ~= nil and t:GetAttribute("Title") ~= nil then
		...
		local xP
		local yP
		if AYMouse.X > 200 then
			xP = x - 201
		else
			xP = x + 21
		end
		if AYMouse.Y > (AYMouse.ViewSizeY-96) then
			yP = y - 97
		else
			yP = y
		end
			...
			if cmd then
				...
				if infTimes then
					while lastBreakTime < cmdStartTime do
						...
						if not success and _G.AY_DEBUG then
...
local MousePositionToVector2 = function()
	return Vector2.new(AYMouse.X, AYMouse.Y)
end
...
local function clicktpFunc()
	pcall(function()
		...
		local hitPosition = AYMouse.Hit.Position
...
AYMouse.Button1Down:Connect(function()
	for i,v in pairs(binds) do
		...
		elseif v.COMMAND == 'clickdel' then
			...
			if input == 'RightClick' and UserInputService:IsMouseButtonPressed(Enum.UserInputType.MouseButton2) then
				pcall(function() AYMouse.Target:Destroy() end)
...
function addPlugin(name)
	if name:lower() == 'plugin file name' or name:lower() == 'AY_fe.AY' or name == 'AY_fe' then
		notify('Plugin Error','Please enter a valid plugin')
	else
		local file
		local fileName
		if name:sub(-3) == '.AY' then
			pcall(function() file = readfile(name) end)
			fileName = name
		else
			pcall(function() file = readfile(name..'.AY') end)
			fileName = name..'.AY'
		end
		if file then
...
Players.LocalPlayer.OnTeleport:Connect(function(State)
	if KeepInfYield and (not TeleportCheck) and queueteleport then
		TeleportCheck = true
		queueteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/EdgeAY/Aetheryield/master/source'))()")
	end
end)
...
addcmd('keepAY', {}, function(args, speaker)
...
addcmd('unkeepAY', {}, function(args, speaker)
	if queueteleport then
		KeepInfYield = false
		updatesaves()
	else
...
addcmd('togglekeepAY', {}, function(args, speaker)
	if queueteleport then
...
function sFLY(vfly)
	...
	flyKeyDown = AYMouse.KeyDown:Connect(function(KEY)
		if KEY:lower() == 'w' then
			CONTROL.F = (vfly and vehicleflyspeed or AYflyspeed)
		elseif KEY:lower() == 's' then
			CONTROL.B = - (vfly and vehicleflyspeed or AYflyspeed)
		elseif KEY:lower() == 'a' then
			CONTROL.L = - (vfly and vehicleflyspeed or AYflyspeed)
		elseif KEY:lower() == 'd' then 
			CONTROL.R = (vfly and vehicleflyspeed or AYflyspeed)
		elseif QEfly and KEY:lower() == 'e' then
			CONTROL.Q = (vfly and vehicleflyspeed or AYflyspeed)*2
		elseif QEfly and KEY:lower() == 'q' then
			CONTROL.E = -(vfly and vehicleflyspeed or AYflyspeed)*2
		end
		pcall(function() workspace.CurrentCamera.CameraType = Enum.CameraType.Track end)
	end)
	flyKeyUp = AYMouse.KeyUp:Connect(function(KEY)
		if KEY:lower() == 'w' then
			CONTROL.F = 0
		elseif KEY:lower() == 's' then
			CONTROL.B = 0
	...
	mfly2 = RunService.RenderStepped:Connect(function()
		...
		if speaker.Character:FindFirstChildWhichIsA("Humanoid") and root and root:FindFirstChild(velocityHandlerName) and root:FindFirstChild(gyroHandlerName) then
			...
			if direction.X > 0 then
				VelocityHandler.Velocity = VelocityHandler.Velocity + camera.CFrame.RightVector * (direction.X * ((vfly and vehicleflyspeed or AYflyspeed) * 50))
			end
			if direction.X < 0 then
				VelocityHandler.Velocity = VelocityHandler.Velocity + camera.CFrame.RightVector * (direction.X * ((vfly and vehicleflyspeed or AYflyspeed) * 50))
			end
			if direction.Z > 0 then
				VelocityHandler.Velocity = VelocityHandler.Velocity - camera.CFrame.LookVector * (direction.Z * ((vfly and vehicleflyspeed or AYflyspeed) * 50))
			end
			if direction.Z < 0 then
				VelocityHandler.Velocity = VelocityHandler.Velocity - camera.CFrame.LookVector * (direction.Z * ((vfly and vehicleflyspeed or AYflyspeed) * 50))
			end
...
addcmd('float', {'platform'},function(args, speaker)
	...
	if pchar and not pchar:FindFirstChild(floatName) then
		task.spawn(function()
			...
			qUp = AYMouse.KeyUp:Connect(function(KEY)
				if KEY == 'q' then
					FloatValue = FloatValue + 0.5
				end
			end)
			eUp = AYMouse.KeyUp:Connect(function(KEY)
				if KEY == 'e' then
					FloatValue = FloatValue - 1.5
				end
			end)
			qDown = AYMouse.KeyDown:Connect(function(KEY)
				if KEY == 'q' then
					FloatValue = FloatValue - 0.5
				end
			end)
			eDown = AYMouse.KeyDown:Connect(function(KEY)
				if KEY == 'e' then
					FloatValue = FloatValue + 1.5
				end
			end)
...
function deleteGuisAtPos()
	pcall(function()
		local guisAtPosition = PlayerGui:GetGuiObjectsAtPosition(AYMouse.X, AYMouse.Y)
		for _, gui in pairs(guisAtPosition) do
...
addcmd('hideAY',{},function(args, speaker)
	isHidden = true
	...
	minimizeNum = 0
	minimizeHolder()
	if not (args[1] and tostring(args[1]) == 'nonotify') then notify('AY Hidden','You can press the prefix key to access the command bar') end
end)

addcmd('showAY',{'unhideAY'},function(args, speaker)
	isHidden = false
	minimizeNum = -20
	if wasStayOpen then
		maximizeHolder()
...
-- Server-sided invisible system
_G.AYInvisibleParts = _G.AYInvisibleParts or {}
_G.AYInvisRunning = false

addcmd('invisible',{'invis'},function(args, speaker)
	if _G.AYInvisRunning then return end
	_G.AYInvisRunning = true
	...
	-- Store and move parts
	for _, part in ipairs(char:GetDescendants()) do
		if part:IsA("BasePart") then
			-- Keep root/torso in place, move other parts 10 studs down
			if part == root or part.Name == "Torso" or part.Name == "UpperTorso" or part.Name == "LowerTorso" then
				part.Transparency = 1
			else
				_G.AYInvisibleParts[part] = part.CFrame
	...
	notify('Invisible','Server-sided invisible enabled. Torso visible, limbs hidden.')
end)

addcmd("visible", {"vis","uninvisible"}, function(args, speaker)
	if not _G.AYInvisRunning then return end
	
	local char = speaker.Character
	if not char then return end
	
	-- Restore original positions
	for part, originalCFrame in pairs(_G.AYInvisibleParts) do
...
addcmd("infjump", {"Aetherjump"}, function(args, speaker)
...
addcmd("uninfjump", {"unAetherjump", "noinfjump", "noAetherjump"}, function(args, speaker)
	if infJump then infJump:Disconnect() end
	infJumpDebounce = false
end)
...
addcmd('tptool', {'teleporttool'}, function(args, speaker)
	...
	TpTool.Activated:Connect(function()
		...
		HRP.CFrame = CFrame.new(AYMouse.Hit.X, AYMouse.Hit.Y + 3, AYMouse.Hit.Z, select(4, HRP.CFrame:components()))
	end)
end)
...
addcmd('hovername',{},function(args, speaker)
	...
	nbUpdateFunc = AYMouse.Move:Connect(updateNameBox)
end)
...
addcmd("addallplugins", {"loadallplugins"}, function(args, speaker)
    ...
    for _, filePath in ipairs(listfiles("")) do
        local fileName = filePath:match("([^/\\]+%.AY)$")

        if fileName and
            fileName:lower() ~= "AY_fe.AY" and
...
task.spawn(function()
	...
	minimizeHolder()
	if IsOnMobile then notify("Mobile Devices", "Mobile Users: Aether Yield have fixed issues or features that are not functioning correctly.") end
end)